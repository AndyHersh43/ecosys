...
class Animal(BaseCreature, ABC):
    def __init__(self, world, color, sex=bool(randint(0,1)), coord=None, radius=None, vision=None, velocity=None):
        super().__init__(world, color, coord=coord, radius=radius)
...
class Herbivore(Animal):
    def __init__(self, world, color=(0, 0, randint(0, 155)+100), sex=bool(randint(0,1)), coord=None, radius=None, vision = None, velocity = None,):
        super().__init__(world, color, sex, coord=coord, radius=radius, vision=vision, velocity=velocity)
    ...
    def search_mate(self, time_elapsed):
        mates = [m for m in self.world.creatures['Herbivore'] if m.sex != self.sex and self.coord.distance_to(m.coord) <= self.vision and m.horny]
...
class Carnivore(Animal):
    def __init__(self, world, color=(randint(0, 155)+100, 0, 0), sex=bool(randint(0,1)), coord=None, radius=None, vision = None, velocity = None,):
        super().__init__(world, color, sex, coord=coord, radius=radius, vision=vision, velocity=velocity)
    ...
    def search_mate(self, time_elapsed):
        mates = [m for m in self.world.creatures['Carnivore'] if m.sex != self.sex and self.coord.distance_to(m.coord) <= self.vision and m.horny]
